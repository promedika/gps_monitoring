                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <a href="#" title="Add" class="btn btn-primary col-2 btn-add-user"><i
                                        class="fa solid fa-plus"></i></a>
                                <a href="#" title="Add" class="btn btn-success col-2 btn-import-user"><i
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" user-id="{{ $user->id }}" title=""
                                                        class="btn btn-warning btn-edit-user"><i
                                                            class="fas fa-edit"></i></a>
                                                    <a href="#" user-id="{{ $user->id }}"
                                                        data-user="{{ $user->first_name . ' ' . $user->last_name }}"
                                                        title="" class="btn btn-danger btn-delete-user"><i
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <a class="btn btn-sm btn-info"
                                href="{{ asset('/assets/template/pic_template_update.xlsx') }}">Download
                                Template</a><br><br>
                            <label for="name">Pilih File</label>
                            <input type="file" name="file" class="name" id="name" accept=".xlsx, .xls"
                                required>
            ...
            <div class="modal-content">
                <form action="javascript:void(0)" method="post" accept-charset="utf-8" id="form-edit">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="password">Password <span style="font-size: 10px; color:red">*Kosongkan jika tidak
                ...
                $('#form-signup').submit(function(e) {
                    ...
                    $.ajax({
                        ...
                        error: function(response) {
                            ...
                            $('#errorFirstName').text(response.responseJSON.errors
                                .first_name);
                            $('#errorLastName').text(response.responseJSON.errors
                                .last_name);
                            ...
                            $('#errorPassword').text(response.responseJSON.errors
                                .password);
                            $('#errorDepartment').text(response.responseJSON.errors
                                .department);
                            $('#errorRole').text(response.responseJSON.errors.role);
                            $('#errorStartDate').text(response.responseJSON.errors
                                .start_date);
                            $('#errorEndDate').text(response.responseJSON.errors
                                .end_date);
